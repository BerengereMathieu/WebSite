...
<?php include('../headerPortefolio.html'); ?>
   ...
   <div class="class=container-fluid content">  
      ...
      <div class="cv_part">
	  <p>	  
	 En marge des réprésentations standards que sont les modèles <a href="https://fr.wikipedia.org/wiki/Rouge_vert_bleu">RGB</a> et <a href="https://fr.wikipedia.org/wiki/Teinte_Saturation_Valeur">HSV</a>, il existe une myriade d'autres espaces colorimétriques, spécifiques à l'analyse d'images. Certains ont été conçus pour se rapprocher de la perception humaine, d'autres pour satisfaire des propriétés statistiques particulières.
	  </p>
	  <p>
Durant mon travail de recherche, j'ai mené des tests sur une dizaine de ces espaces colorimétriques : XYZ, RGB, HSI, LUV, LAB, AC1C2, YC1C2, A1A2A3, H1H2H3. Afin de vérifier et de comprendre les résultats obtenus, j'ai réfléchi à des manières de les visualiser. VASCO (à l'envers et en anglais : COlor Space Atypical Visualization) consitue une tentative de réprésentation en 3D, chaque dimension géométrique correspondant à une composante colorimétrique. Par exemple pour une couleur exprimée dans l'espace HSI, sa teinte (H) correspond à sa position sur l'axe x, la saturation (S) à celle sur l'axe y et son intensité lumineuse (I) à sa profondeur, z. En plus d'afficher l'intégralité d'un espace colorimétrique, VASCO permet de charger une image et d'observer comment ses couleurs se distribuent dans cet espace.</p>
      <p>
      Il m'a semblé intéressant de le mettre à disposition des curieux, capables de passer quelques minutes à explorer un monde de couleurs.
      </p>
      </div>      
